...
const Answer = ({ _id }) => {
  ...
  return (
    <div className="mt-20">
      ...
      <div className="mb-4">
        <textarea onChange={e => setAnswer(e.target.value)} value={answer} className="form-control w-full h-36 mt-3 shadow border rounded-lg py-2 px-3 text-black text-base leading-tight focus:outline-none focus:shadow-outline focus:border-greentea" id="answer" type="text" />
      </div>
